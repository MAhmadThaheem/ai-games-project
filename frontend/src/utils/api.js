...
export const gameAPI = {
  ...
  makeChessMove: (gameId, move) => api.post(`/api/chess/${gameId}/move`, move),

  getChessLegalMoves: (gameId, square) =>
    api.get(`/api/chess/${gameId}/legal-moves`, { params: { square } }),

  getChessGameState: (gameId) => api.get(`/api/chess/${gameId}`),
  ...
  getConnect4GameState: (gameId) => api.get(`/api/connect4/${gameId}`),
